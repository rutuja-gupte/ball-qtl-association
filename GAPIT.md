...
``` r
run_gapit <- function(vcf.name, pheno.name, f1 = "gapit1.txt", f2 = "gapit2.hmp.txt"){
...
``` r
run_gapit("gt5382/gt5382_processed.vcf.gz", "gt5382/gt5382_traits.txt", "gt5382/gapit1.txt", "gt5382/gapit2.hmp.txt")
```
    ...
    ## null model done! pseudo-h= 0.195 
    ## step 1 done! pseudo-h= 0.136 
    ## step  2  done! pseudo-h= 0.007 
    ...
    ## [1] 20.7981005 22.5247087  2.5853927 11.3460786 20.5263840 20.2654181  0.1639001
    ## [8]  0.2152987
    ## [1] "Creating marker p-value, MAF, estimated effect, PVE 3 plot..."

    ## [1]   71   74  277  534  748  816 1338 1339
    ...
    ## [1] "optimizing possible QTNs..."
    ## [1] "seqQTN"
    ## [1]  816  748   74  277   41 1338  116 1277
    ## [1] "scanning..."
    ## [1] "number of covariates in current loop is:"
    ## [1] 13
    ...
    ## [1] "optimizing possible QTNs..."
    ## [1] "seqQTN"
    ## [1]  816  748   74 1338  116  277 1277   71   41
    ## [1] "scanning..."
    ## [1] "number of covariates in current loop is:"
    ## [1] 14
    ...
    ## [1] "optimizing possible QTNs..."
    ## [1] "seqQTN"
    ##  [1]  816  748   74 1338  116   71  277 1277   63   41
    ## [1] "scanning..."
    ## [1] "number of covariates in current loop is:"
    ## [1] 15
    ...
    ## [1] "optimizing possible QTNs..."
    ## [1] "seqQTN"
    ##  [1]  816  748   74  116 1338  277   71 1277   63   41
    ## [1] "scanning..."
    ## [1] "number of covariates in current loop is:"
    ## [1] 15
    ...
    ## [1] "Candidate Genes could Phenotype_Variance_Explained(%) :"
    ## [1] 0.000000 0.000000 3.590975 0.000000 0.000000
    ## [1] "Creating marker p-value, MAF, estimated effect, PVE 3 plot..."

    ## [1] "FarmCPU has been done succeedly!!"
    ## [1]   71   74  116  277  748  816 1277 1338
    ## [1] "GAPIT.ID in process..."
    ## [1] "Filtering SNPs with MAF..."
    ## [1] "Calculating FDR..."
    ## [1] "QQ plot..."
    ...
    ## [1] "select 2 candidate significont markers in 7 chromosome "
    ...
    ## [1] 8
    ## [1] "seqQTN:"
    ## [1]  816  748   74   71 1339  116  277 1343
    ## [1] "----------------------Iteration: 5 ----------------------"
    ## [1] "LD remove is working...."
    ## [1] "Number SNPs for LD remove:"
    ## [1] 8
    ...
    ## [1] 8
    ## [1] "seqQTN:"
    ## [1]  816  748   74   71  116 1339  277 1343
    ## [1] "LD.time(sec):"
    ## [1] 0 0 0 0 0
    ## [1] "BIC.time(sec):"
    ## [1] 0 0 0 0 0
    ## [1] "GLM.time(sec):"
    ## [1] 1.30 1.25 1.32 1.20 0.97
    ## [1] "-------------Blink finished successfully in 9.48 seconds!-----------------"
    ## [1] "Calculating Original GWAS result..."
    ## [1] "GAPIT.RandomModel beginning..."
    ## [1] FALSE
    ## [1] "Candidate Genes could Phenotype_Variance_Explained(%) :"
    ## [1] 17.5353968 18.4545961 16.0850770 12.0896522 17.2507136 17.0553549  0.3979068
    ## [1] "Creating marker p-value, MAF, estimated effect, PVE 3 plot..."
